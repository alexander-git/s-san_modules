...
use app\modules\personal\models\search\DocsListSearch;
use app\modules\personal\exceptions\CanNotBeDeletedException;


class DocsListController extends DefaultController
{
    ...
    {
        $searchModel = new DocsListSearch();
    ...
    public function actionUpdate($id)
    {
        ...
        $model->scenario = DocsList::SCENARIO_UPDATE;
    ...
    public function actionDelete($id)
    {
        $model =  $this->findModel($id);
        try {
            $success = DocsList::deleteDocsList($model);
            if (!$success) {
